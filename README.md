# Behind the Data: Humans and Values | Summer 2021
...
1. **Case Study (for discussion)**: DTC genetic testing
   ...
   * **SKIM** https://www.themarshallproject.org/2018/04/19/framed-for-murder-by-his-own-dna - this is a case study of DNA identification gone wrong. Content warning: description of violent robbery; skip to below the crime scene photo montage if you want to avoid it.
...
1. **OPTIONAL** Tukufu Zuberi. _Thicker than Blood: How Racial Statistics Lie._ 2001, University of Minnesota Press. https://www.jstor.org/stable/10.5749/j.cttttcnc
</details>
...
1. **Case Study (for discussion):** none - presentations of privacy policy assignments
...
1. **Case Study (for discussion)**: ownership of DTC genetic data
   * https://www.ftc.gov/system/files/documents/public_comments/2015/10/00057-98101.pdf
   * https://www.snopes.com/fact-check/ancestry-dna-steal-own/ 
   * Optional - for overview: https://sitn.hms.harvard.edu/flash/2018/understanding-ownership-privacy-genetic-data/
...
1. **Case Study (for discussion):** TBD
